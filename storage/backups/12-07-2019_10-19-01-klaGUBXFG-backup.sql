...
-- Date: Fri, 12 Jul 2019 10:19:01 +0700
...
-- Dumped table `ks_answer` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `ks_menu` VALUES (75,'Menu Truy cập','Menu Truy cập',1,1,0,1,1,'Menu Truy cập',1,'1','1','1','1','1');
/*!40000 ALTER TABLE `ks_menu` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_menu` with 1 row(s)
--
...
CREATE TABLE `ks_menu_role` (
  `ID_mero` int(11) NOT NULL AUTO_INCREMENT,
  `ID_Menu` int(11) NOT NULL,
  `ID_Role` int(11) NOT NULL,
  `mero_isActive` int(11) DEFAULT NULL,
  `mero_note1` text COLLATE utf8_unicode_ci,
  `mero_note2` text COLLATE utf8_unicode_ci,
  `mero_note3` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`ID_mero`),
  KEY `ID_Menu` (`ID_Menu`),
  KEY `ID_Role` (`ID_Role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `ks_organisation`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ks_organisation` (
  `org_id` int(11) NOT NULL AUTO_INCREMENT,
  `org_name` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `org_idCreated` int(11) DEFAULT NULL,
  `org_idAssigned` int(11) DEFAULT NULL,
  `org_idParent` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `ks_organisation`
--

LOCK TABLES `ks_organisation` WRITE;
/*!40000 ALTER TABLE `ks_organisation` DISABLE KEYS */;
SET autocommit=0;
/*!40000 ALTER TABLE `ks_organisation` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_organisation` with 0 row(s)
--
...
CREATE TABLE `ks_question` (
  ...
  `question_isActive` int(11) DEFAULT NULL,
...
-- Dumped table `ks_question` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `ks_role` VALUES (6,'Nhân Viên',1,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `ks_role` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_role` with 1 row(s)
--
...
-- Dumped table `ks_survey` with 0 row(s)
--
...
CREATE TABLE `ks_topic` (
  ...
  `topic_isActive` int(11) DEFAULT NULL,
  `topic_created_at` datetime NOT NULL,
...
-- Dumped table `ks_topic` with 0 row(s)
--
...
CREATE TABLE `setting` (
  ...
  KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=3383 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `setting` VALUES (3293,'config','config_meta_title','Quản lý hồ sơ UBND Phường Linh Trung1',0),(3299,'config','config_meta_description','Hồ sơ 1 cửa phục vụ quản lý công việc tại Phường',0),(3353,'config','config_ks_meta_title','Hệ thống khảo sát hài lòng',0),(3354,'config','config_logo','/avatars/configlogo2',0),(3355,'config','config_tencoquan','Ủy ban nhân dân Phường Linh Trung1',0),(3356,'config','config_diachi','1262 Kha Vạn Cân, Phường Linh Trung, Thủ Đức, Hồ Chí Minh',0),(3357,'config','config_sodienthoai','028 3896 6594',0),(3358,'config','config_emailcoquan','linhtrung.thuduc@tphcm.gov.vn',0),(3359,'config','config_ks_meta_description','Hệ thống khảo sát hài lòng',0),(3360,'config','config_dossier_limit','10',0),(3361,'config','config_bacode_symbology','qr',0),(3362,'config','config_barcode-width','100',0),(3363,'config','config_barcode-height','100',0),(3364,'config','config_barcode-padding','1',0),(3365,'config','config_temp_guiemail','10',0),(3366,'config','config_temp_guisms','11',0),(3367,'config','config_temp_biennhanhoso','12',0),(3368,'config','config_temp_chuyenhoso','13',0),(3369,'config','config_mail_protocol','smtp',0),(3370,'config','config_mail_parameter',NULL,0),(3371,'config','config_mail_smtp_hostname','smtp.gmail.com',0),(3372,'config','config_mail_smtp_username','nhakhoahoc.net@gmail.com',0),(3373,'config','config_mail_smtp_password','kzfimgzsaklzkwdb',0),(3374,'config','config_mail_smtp_port','587',0),(3375,'config','config_mail_encryption','tls',0),(3376,'config','config_mail_smtp_timeout','5',0),(3377,'config','config_sms_provider','esms.vn',0),(3378,'config','config_esmsvn_api_key','4E3E517F46E713FEC2F8AD8BE2D9D2',0),(3379,'config','config_esmsvn_secret_key','6C93319C7985AE7B2250B9042C10D6',0),(3380,'config','config_maintenance','0',0),(3381,'config','config_radiotimebackup','hourlyAt',0),(3382,'config','config_backup_time','hourlyAt,17,',0);
/*!40000 ALTER TABLE `setting` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `setting` with 32 row(s)
--
...
CREATE TABLE `users` (
  ...
  `survey_user_level` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `users_ibfk_3` FOREIGN KEY (`ID_ks_Role`) REFERENCES `ks_role` (`ID_Role`)
...
SET autocommit=0;
INSERT INTO `users` VALUES (1,'LTR-13021970','admin@gmail.com','$2y$10$mzWuyxUdsrfVyvj5a718MuN3klzV.3fkhEnD9Q0Bl2iiUan9rVpeW','Admin','1970-02-13 00:00:00',1,'0904585845','0904585845','156 Nhật Tảo, phường 8, quận 10, TPHCM','/avatars/1Chrysanthemum.jpg',6,1,6,1,1,NULL,'','','','','','iZQsool0oJdHnjfFaYFFi10ea76EsX9v00ILKYZmt3JKzIXzJEBXKIroBh1v'),(2,'mnv1562019u1','user1@gmail.com','$2y$10$Isnrvi0WQzr6w/DY1bOSvu36IDOOzdNtI3P0wYlDAWzHwl6wAVQFC','Trần Quốc Hưng','1991-07-25 00:00:00',1,'909509109','0909239139','157 nhật tảo','/avatars/1Hydrangeas.jpg',1,4,6,1,2,NULL,'','','','','',NULL),(3,'mnv156u2157','user2@gmail.com','$2y$10$M6c2qzm6GaHvWdg/ts.f5O1SI1QBW9CdwsKqHLid.t8P.ze3a1j8e','user hai-phó chủ tịch','1990-10-30 00:00:00',1,'909520170','0986532172','157 nhật nhật tảo','/avatars/3Chrysanthemum.jpg',2,4,6,1,2,NULL,'','','','','',NULL),(4,'mnv156u3157','user3@gmail.com','$2y$10$zWRl0LntgT9mfWixvJMQpuosCGAnyuyrpPbGDj39IIo7leqeC4aKS','user ba-phó chủ tịch','1990-08-29 00:00:00',1,'956236246','0986256254','090 nhật tảo','/storage/avatars/4TTCH3VOGCUM001 (6).JPG',2,4,6,1,2,NULL,'','','','','','hrebkL74sLkbwOYvvIGVHe83Cq3cw4lwHI4mMU39aJVjd2ECqkBG6drqJa6o'),(5,'mnv156u4157111','user4@gmail.com','$2y$10$b941kCAFPp8J3PIxfOVkyeaVnUh.KWARWan1f2vVbH2y5eWFCIqN.','user4 (1cua-tư pháp)','1985-06-29 00:00:00',0,'963234259','0964267257','156 nhật tảo tảo','/avatars/5IMG_0700.JPG',6,3,6,1,2,NULL,'','','','','','t74QMKh9aUuIDqq1XkiYh3ARIpEQUxMZoi4yz69zCir9cWp8XY3n5UmrSs4s'),(6,'nhanvien00001','user5@gmail.com','$2y$10$qEoV9wtpLD4Jk01YqnpNOuFA.RtEA6aqf/9XbL.0W.guk9.oQiO4m','user5 (tư pháp)','1999-04-03 00:00:00',1,'9999','09999','Đồng Nai','/storage/avatars/6Koala.jpg',6,3,6,1,2,NULL,'','','','','','lwYByzN2rXMRy4xRhFtuI2HhChtIw0qsovnLNB8Kaf8FF9Z8C0DFTsabe1nG'),(7,'user6','user6@gmail.com','$2y$10$IK4xAGmv8b3PN8FwayoKve5w58uz/ZPKtIr6psoFJ6HpKd.VXIE42','user6 (THANH TRA)','1990-01-01 00:00:00',1,'9999','09999','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','$request->avatar',6,3,6,1,2,NULL,'','','','','',NULL),(8,'user4','user7@gmail.com','$2y$10$ytZRvNks/5ZxeHjVsT/qLuXpdSCoNriO6/c8zwJIkqq3VFqB81ymK','user7 (GIÁO DỤC - ĐÀO TẠO)','2014-05-02 00:00:00',1,'9999','09999','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','$request->avatar',6,3,6,1,2,NULL,'','','','','','uFMEglAz6ryjL6ajqoGX9XR5KCqVpzRQjNQ0xQIzKWBJeZW2bMN40OR8gcV0'),(13,'user8','user8@gmail.com','$2y$10$iOzvmGFjWCoj6lUpGoO4Bu7uktGVPUhPRRoRPMbpkJi8LYEYHaoZ.','user8 (LAO ĐỘNG THƯƠNG BINH & XÃ HỘI)','1990-01-11 00:00:00',0,'1111','1111','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','$request->avatar',6,3,6,1,2,NULL,'','','','','',NULL),(14,'aaa','user9@gmail.com','$2y$10$fCPZz8T8MRJHKXE3E7XVQOb6ixGHNSIGiLzHarULCaWV8zLgc46MO','user9 (LAO ĐỘNG THƯƠNG BINH & XÃ HỘI)','2019-05-09 00:00:00',1,'99','099','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','$request->avatar',6,3,6,1,2,NULL,'','','','','',NULL),(15,'giam sát','giamsat1@gmail.com','$2y$10$X4XpdnNVFwKJn9RJBw50hejU5oWSvvasVCqkwkyX.0ASl/iYLCk..','giám sát 1','2019-05-01 00:00:00',1,'9999','09999','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','/storage/avatars/15TTCH3VOGCUM006 (3).JPG',6,2,6,1,2,NULL,'','','','','',NULL),(16,'us11','us11@gmail.com','$2y$10$Tac/UTGGc.WizoTcSXUkLuV1jl9BMuXWi/CdLYqdEy25voMrdc4jy','us11-công thưuong','2019-06-08 00:00:00',1,'99999999999','890','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','/avatars/1Jellyfish.jpg',6,3,6,1,2,NULL,'','','','','',NULL),(17,'us12','us12@gmail','$2y$10$1Goq87eHxzWMqDRa0e62eePc7wGzQhNwNgDHloQKT7KUsuR3PzN6.','us12-xử lý công thương','2019-06-07 00:00:00',1,'67777777777777777','11144444444444444444','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','/avatars/1Tulips.jpg',6,3,6,1,2,NULL,'','','','','',NULL),(18,'123456','user13@gmail.com','$2y$10$xeRwrzyIqbY/MT851JNjYuiRrKrqUTu9bLjf.ODY3vL52fQz1rMRe','nhân viên 13','2003-02-01 00:00:00',0,'123456789','123456789','111 đường không tên','/avatars/1Vo_Tran_Ngoc_Huyen.jpg',6,3,6,1,2,NULL,'','','','','',NULL),(19,'111111','phong2018@gmail.com','$2y$10$HnL8I3LU9KyC34OqpzeI1.Hdog9rubj6uFdnVSZx6neq2CuCKoCym','111111','2019-07-19 00:00:00',1,'09999','121213','197, Phạm Văn Thuận, Biên Hòa, Đồng Nai','/avatars/1Tulips.jpg',1,1,6,1,2,NULL,'','','','','',NULL);
...
-- Dump completed on: Fri, 12 Jul 2019 10:19:01 +0700
