...
-- Date: Sun, 02 Jun 2019 10:19:15 +0700
...
SET autocommit=0;
INSERT INTO `dossier` VALUES (122,'1559307952001','Đăng ký khai sinh thông thường','Lê Giang Phong','thạnh phú','phong2018@gmail.com',971793662,1231313,'2019-05-31 00:00:00','2019-06-05 00:00:00',1,1,5,1,1,'storage/history/2019/5/31/1559307952001-Dossier-sTmgLFV3h.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(123,'1559358742123','Cấp sửa đổi, bổ sung Giấy xác nhận đăng ký sản xuất rượu thủ công đẻ bán cho doanh nghiệp có giấy phép sản xuất rượu để chế biến lại','phong111','dia chi1','email1@gmail.com',99999,22222,'2019-06-01 00:00:00','2019-06-11 00:00:00',32,19,15,6,1,'storage/history/2019/6/1/1559358742123-Dossier-xOCnwckxS.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(124,'1559440923124','Giải quyết tố cáo','phong2-6-1','dia chi- phong2-6-1','phong2018@gmail.com',99999,11111,'2019-06-02 00:00:00','2019-06-07 00:00:00',22,6,5,1,1,'storage/history/2019/6/2/1559440923124-Dossier-Ui5P3RIHp.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
SET autocommit=0;
INSERT INTO `position` VALUES (1,'Chủ Tịch Phường',1,'Chủ Tịch Phường',0,'null','null','null','null','null'),(2,'Phó Chủ Tịch Phường',1,'Phó Chủ Tịch Phường',0,'null','null','null','null','null'),(6,'Nhân Viên/ Chuyên Viên',1,'Nhân Viên/ Chuyên Viên',0,'null','null','null','null','null');
/*!40000 ALTER TABLE `position` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `position` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `sector` VALUES (1,'TƯ PHÁP',1,'1','1','1','1','1'),(6,'THANH TRA',1,'1','1','1','1','1'),(7,'GIÁO DỤC - ĐÀO TẠO',1,'1','1','1','1','1'),(12,'LAO ĐỘNG THƯƠNG BINH & XÃ HỘI',1,'1','1','1','1','1'),(14,'ĐỊA CHÍNH - TÀI NGUYÊN MÔI TRƯỜNG',1,'1','1','1','1','1'),(15,'TÀI CHÍNH',1,'1','1','1','1','1'),(16,'VĂN HÓA - THÔNG TIN',1,'1','1','1','1','1'),(17,'NỘI VỤ',1,'1','1','1','1','1'),(19,'Công thương',1,'1','1','1','1','1');
/*!40000 ALTER TABLE `sector` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `sector` with 9 row(s)
--
...
CREATE TABLE `setting` (
  ...
  KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=2933 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `setting` VALUES (2903,'config','config_meta_title','Hồ Sơ Một Cửa',0),(2904,'config','config_logo','/photos/1/Lighthouse.jpg',0),(2905,'config','config_tencoquan','UBND Phường An Bình Biên Hòa Đồng Nai',0),(2906,'config','config_diachi','Địa chỉ Phạm Văn Thuận',0),(2907,'config','config_sodienthoai','123456',0),(2908,'config','config_emailcoquan','emailcoquan@gmail.com',0),(2909,'config','config_meta_description','Hồ sơ 1 cửa phục vụ quản lý công việc tại Phường',0),(2910,'config','config_dossier_limit','10',0),(2911,'config','config_bacode_symbology','qr',0),(2912,'config','config_barcode-width','100',0),(2913,'config','config_barcode-height','100',0),(2914,'config','config_barcode-padding','1',0),(2915,'config','config_temp_guiemail','10',0),(2916,'config','config_temp_guisms','11',0),(2917,'config','config_temp_biennhanhoso','12',0),(2918,'config','config_temp_chuyenhoso','13',0),(2919,'config','config_mail_protocol','smtp',0),(2920,'config','config_mail_parameter',NULL,0),(2921,'config','config_mail_smtp_hostname','smtp.gmail.com',0),(2922,'config','config_mail_smtp_username','Le20183@gmail.com',0),(2923,'config','config_mail_smtp_password','qsgvxyjgiudlzjyk',0),(2924,'config','config_mail_smtp_port','587',0),(2925,'config','config_mail_encryption','tls',0),(2926,'config','config_mail_smtp_timeout','5',0),(2927,'config','config_sms_provider','esms.vn',0),(2928,'config','config_esmsvn_api_key','4E3E517F46E713FEC2F8AD8BE2D9D2',0),(2929,'config','config_esmsvn_secret_key','6C93319C7985AE7B2250B9042C10D6',0),(2930,'config','config_maintenance','0',0),(2931,'config','config_radiotimebackup','hourlyAt',0),(2932,'config','config_backup_time','hourlyAt,17,',0);
...
SET autocommit=0;
INSERT INTO `task_appointed` VALUES (178,122,5,NULL,5,NULL,1,'2019-05-31 20:05:52',NULL,NULL,NULL,NULL,NULL),(179,123,16,NULL,16,NULL,1,'2019-06-01 10:12:22',NULL,NULL,NULL,NULL,NULL),(180,123,17,NULL,16,NULL,1,'2019-06-01 10:13:25',NULL,NULL,NULL,NULL,NULL),(181,123,15,NULL,16,NULL,0,'2019-06-01 10:14:02',NULL,NULL,NULL,NULL,NULL),(182,123,3,NULL,17,NULL,0,'2019-06-01 10:16:57',NULL,NULL,NULL,NULL,NULL),(183,124,5,NULL,5,NULL,1,'2019-06-02 09:02:03',NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `task_appointed` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `task_appointed` with 6 row(s)
--
...
SET autocommit=0;
INSERT INTO `template` VALUES (10,'Mẫu gửi Email','Mẫu gửi Email','/views/admin/temp/temp10.blade.php','admin.temp.temp10',NULL,NULL,'2019-06-01 10:31:50','2019-06-01 10:34:46'),(11,'Mẫu gửi tin nhắn','Mẫu gửi tin nhắn','/views/admin/temp/temp11.blade.php','admin.temp.temp11',NULL,NULL,'2019-06-01 10:32:47','2019-06-01 10:34:29'),(12,'Mẫu biên nhận hồ sơ','Mẫu biên nhận hồ sơ','/views/admin/temp/temp12.blade.php','admin.temp.temp12',1,'{{$data[\'BarCode\'}} {{$data[\'MaHoSo\'}} {{$data[\'TenHoSo\'}} {{$data[\'ChuHoSo\'}} {{$data[\'DiaChiChuHoSo\'}} {{$data[\'EmailChuHoSo\'}} {{$data[\'DienThoaiChuHoSo\'}} {{$data[\'ZaloChuHoSo\'}} {{$data[\'NgayNhanHoSo\'}} {{$data[\'NgayTraHoSo\'}} {{$data[\'TenCoQuan\'}} {{$data[\'DiaChiCoQuan\'}} {{$data[\'DienThoaiCoQuan\'}} {{$data[\'EmailCoQuan\'}} {{$data[\'MoTaCoQuan\'}}','2019-06-01 10:33:10','2019-06-02 10:05:12'),(13,'Mẫu chuyển Hồ Sơ','Mẫu chuyển Hồ Sơ','/views/admin/temp/temp13.blade.php','admin.temp.temp13',NULL,'{{$data[\'BarCode\'}} {{$data[\'MaHoSo\'}} {{$data[\'TenHoSo\'}} {{$data[\'ChuHoSo\'}} {{$data[\'DiaChiChuHoSo\'}} {{$data[\'EmailChuHoSo\'}} {{$data[\'DienThoaiChuHoSo\'}} {{$data[\'ZaloChuHoSo\'}} {{$data[\'NgayNhanHoSo\'}} {{$data[\'NgayTraHoSo\'}} {{$data[\'TenCoQuan\'}} {{$data[\'DiaChiCoQuan\'}} {{$data[\'DienThoaiCoQuan\'}} {{$data[\'EmailCoQuan\'}} {{$data[\'MoTaCoQuan\'}}','2019-06-01 10:33:48','2019-06-02 10:06:30');
...
-- Dump completed on: Sun, 02 Jun 2019 10:19:15 +0700
