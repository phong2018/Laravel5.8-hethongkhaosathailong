...
SET autocommit=0;
INSERT INTO `setting` VALUES (2933,'config','config_meta_title','Hồ Sơ Một Cửa',0),(2934,'config','config_logo','/photos/1/Lighthouse.jpg',0),(2935,'config','config_tencoquan','Ủy ban nhân dân Phường Linh Trung',0),(2936,'config','config_diachi','1262 Kha Vạn Cân, Phường Linh Trung, Thủ Đức, Hồ Chí Minh',0),(2937,'config','config_sodienthoai','028 3896 6594',0),(2938,'config','config_emailcoquan','linhtrung.thuduc@tphcm.gov.vn',0),(2939,'config','config_meta_description','Hồ sơ 1 cửa phục vụ quản lý công việc tại Phường',0),(2940,'config','config_dossier_limit','10',0),(2941,'config','config_bacode_symbology','qr',0),(2942,'config','config_barcode-width','100',0),(2943,'config','config_barcode-height','100',0),(2944,'config','config_barcode-padding','1',0),(2945,'config','config_temp_guiemail','10',0),(2946,'config','config_temp_guisms','11',0),(2947,'config','config_temp_biennhanhoso','12',0),(2948,'config','config_temp_chuyenhoso','13',0),(2949,'config','config_mail_protocol','smtp',0),(2950,'config','config_mail_parameter',NULL,0),(2951,'config','config_mail_smtp_hostname','smtp.gmail.com',0),(2952,'config','config_mail_smtp_username','Le20183@gmail.com',0),(2953,'config','config_mail_smtp_password','qsgvxyjgiudlzjyk',0),(2954,'config','config_mail_smtp_port','587',0),(2955,'config','config_mail_encryption','tls',0),(2956,'config','config_mail_smtp_timeout','5',0),(2957,'config','config_sms_provider','esms.vn',0),(2958,'config','config_esmsvn_api_key','4E3E517F46E713FEC2F8AD8BE2D9D2',0),(2959,'config','config_esmsvn_secret_key','6C93319C7985AE7B2250B9042C10D6',0),(2960,'config','config_maintenance','0',0),(2961,'config','config_radiotimebackup','hourlyAt',0),(2962,'config','config_backup_time','hourlyAt,17,',0);
...
-- Dump completed on: Tue, 04 Jun 2019 21:26:35 +0700
