...
-- Date: Tue, 16 Jul 2019 09:40:32 +0700
...
-- Dumped table `backup` with 15 row(s)
--
...
SET autocommit=0;
INSERT INTO `ks_role` VALUES (6,'Quản Trị',1,NULL,NULL,NULL,NULL,NULL),(7,'Giám Sát',1,NULL,NULL,NULL,NULL,NULL),(8,'Nhân Viên',1,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `ks_role` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_role` with 3 row(s)
--
...
-- Dump completed on: Tue, 16 Jul 2019 09:40:32 +0700
