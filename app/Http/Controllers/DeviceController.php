...
class DeviceController extends Controller
{
    ...
    public function index()
    {
        ...
        if($tempus->user_level>1){
           $orgt=Organization::orderBy('org_id', 'DESC')->where('org_id',$tempus->user_IdOrg)->get()->first();
           if($orgt->org_level==2)
             $org=Organization::orderBy('org_id', 'DESC')->where('org_id',$orgt->org_idParent)->get()->first();
           else $org=$orgt;
        ...
        else $data['orgs'] = Organization::orderBy('org_id', 'DESC')->where("org_id","=",$_GET['filter_device_orgid'])->get();
    ...
    public function edit($id)
    {
        ...
        $data['orgs'] = Organization::orderBy('org_id', 'DESC')->where("org_isActived",">",0)->where("org_level","=",1);
