...
class OrganizationController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach($org as $no=>$val){
            $org_child[$no] = Organization::orderBy('org_id', 'DESC')->where('org_idParent',$val->org_id)->get();
        }

       // $orgs= Organization::orderBy('org_id', 'DESC')->where("org_isActived",">",0)->where("org_level","=",1)->get();
