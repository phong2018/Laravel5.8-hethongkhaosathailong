...
@if(Auth::user()->user_level==1)
       ...
       <li id="thuoctinhhoso"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span>Quản lý Khảo sát</span></a>
          <ul class="collapse" >
            ...
            <li><a href="<?php echo e(asset('/admin/device')); ?>"> Quản lý thiết bị</a></li>
            <li><a href="<?php echo e(asset('/admin/schedule')); ?>"> Quản lý Lập lịch</a></li>
            
            
          </ul>
        </li>
        <li><a href="<?php echo e(asset('/admin/organization')); ?>"> <i class="fa fa-cubes"></i> &nbsp Đơn vị / Bộ phận</a></li>
        ...
        <li id="caidathethong"  ><a class="parent"><i class="fa fa-cog fa-fw"></i> <span>Cài Đặt Hệ Thống</span></a>
          <ul class="collapse" >
            <li><a href="<?php echo e(asset('/admin/setting/edit')); ?>">Thiết Lập Chung</a></li>
              <li class='plghidden'><a href="<?php echo e(asset('/admin/temp')); ?>">Quản Lý Mẫu</a></li>
