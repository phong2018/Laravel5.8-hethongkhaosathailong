...
<div class='col-xs-3 col-sm-3 col-md-3 col-lg-3 khungorglv1 ' style="<?php if($no==0) echo 'display:block;margin:auto;'; ?>padding:5px" >
<div id="flip{{$no}}" class='khungorglv2' style="min-height: 120px;padding:7px">
    <a href="{{ URL::to('survey/selectemp/')}}/{{$val->org_id}}" style='text-decoration: none;font-size:  16px'>
      <img class='thumbemp' style="margin:auto;width:35%" src='{{url("/")}}/public/{{$val->org_image}}'/><br>    
