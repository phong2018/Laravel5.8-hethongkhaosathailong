   ...
   <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        @endif
        <a href="{{ route('organization.create')}} " class="pull-right btn btn-primary">
		<span class="glyphicon glyphicon-plus-sign"></span> Tạo Mới Đơn vị/ Bộ phận
		</a>
    </div>
  </div>
           ...
           <div class="col-sm-10">
              <div class="form-group">
                <label class="control-label" for="input-org_id">
                  <span data-toggle="tooltip" data-container="" title="" data-original-title="Chọn Phường.">Chọn Phường</span>
                </label>
		...
		<table class="table panel panel-default">
			...
			<tbody>
				...
				<tr> 
					...
					<a data-original-title="Sửa Chức Vụ" data-toggle="tooltip" class=' btn btn-success' href="{{ URL::to('admin/organization/' . $val->org_id. '/edit')}}"><i class="fas fa-edit"></i></a></td>
					<td> &nbsp &nbsp </td>
					<td>
					<a data-original-title="Sao chép đơn vị" data-toggle="tooltip" class=' btn btn-success' href="{{ URL::to('admin/organization/' . $val->org_id. '/copy')}}"><i style='padding-top: 3px;padding-left:5px;font-size: 16px;' class="fa fa-plus-square-o"></i></a></td>
					<td> &nbsp &nbsp </td>

					<td>
					<span data-original-title="Xóa Chức vụ" data-toggle="tooltip" class=' btn btn-danger' onclick="delObj({{$val->org_id}})" ><i class="fa fa-trash-o " ></i></span></td>
					</table>
					</td> 
					<?php $i++;?>
				</tr>
						...
						<tr>
							...
							<td>
		 					<table class='iconaction'><td>
							<a data-original-title="Sửa Chức Vụ" data-toggle="tooltip" class=' btn btn-success' href="{{ URL::to('admin/organization/' . $val1->org_id. '/edit')}}"><i class="fas fa-edit"></i></a></td>

							<td> &nbsp &nbsp </td>
					<td> 
					<a data-original-title="Sao chép đơn vị" data-toggle="tooltip" class=' btn btn-success' href="{{ URL::to('admin/organization/' . $val1->org_id. '/copy')}}"><i style='padding-top: 3px;padding-left:5px;font-size: 16px;' class="fa fa-plus-square-o"></i></a></td>
							<td> &nbsp &nbsp </td><td>
							<span data-original-title="Xóa Chức vụ" data-toggle="tooltip" class=' btn btn-danger' onclick="delObj({{$val1->org_id}})" ><i class="fa fa-trash-o " ></i></span></td>
							</table>
							</td> 
							<?php $ii++;?>
						</tr>
