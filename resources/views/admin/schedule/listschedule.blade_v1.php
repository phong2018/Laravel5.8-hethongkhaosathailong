		...
		<tr>
			...
			<td>
				...
				<table class='iconaction'><td>
					<a data-original-title="Sửa Thông Lịch làm việc" data-toggle="tooltip" class=' btn btn-success' href="{{ URL::to('admin/schedule/' . $schedule->schedule_id . '/edit')}}"><i class="fas fa-edit"></i></a></td><td> &nbsp &nbsp </td>
          <?php if($data['uslv1']==1){ ?>
          <td><span data-original-title="Xóa lịch làm việc" data-toggle="tooltip" class=' btn btn-danger' onclick="delObj({{$schedule->schedule_id}})" ><i class="fa fa-trash-o " ></i></span></td>
          <?php } ?>
        </table>
